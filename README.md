...
```
python main.py --seed 1 --cfg config/CIFAR100_LT/lade.yaml --exp_name cvpr2021/cifar100_imb0.01_lade --cifar_imb_ratio 0.01 --remine_lambda 0.01 --alpha 0.1 --gpu 0
```
...
```
python main.py --seed 1 --cfg config/Places_LT/ce.yaml --exp_name cvpr2021/places_pc_softmax --lr 0.05 --gpu 0,1,2,3
```

For LADE:

```
python main.py --seed 1 --cfg config/Places_LT/lade.yaml --exp_name cvpr2021/places_lade --lr 0.05 --remine_lambda 0.1 --alpha 0.005 --gpu 0,1,2,3
```
...
```
python main.py --seed 1 --cfg config/ImageNet_LT/lade.yaml  --exp_name cvpr2021/imagenet_lade --lr 0.05 --remine_lambda 0.5 --alpha 0.05 --gpu 0,1,2,3
```
...
```
python main.py --seed 1 --cfg ./config/iNaturalist18/lade.yaml --exp_name cvpr2021/inat_lade --lr 0.1 --alpha 0.05 --gpu 0,1,2,3 
```
